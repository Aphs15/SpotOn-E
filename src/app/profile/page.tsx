...
const user = {
    ...
    avatar: '/Images/pro/user.jpeg',
    avatarHint: 'man smiling',
    joined: 'October 2024',
};

const savedEvents = [
    { id: '1', name: 'Cape Town International Jazz Festival', date: 'Oct 26, 2024', image: '/Images/eventsI/Derp.jpg', imageHint: 'jazz music festival' },
    { id: '2', name: 'Soweto Derby', date: 'Nov 09, 2024', image: '/Images/eventsI/Ms.jpg', imageHint: 'soccer stadium' },
];
